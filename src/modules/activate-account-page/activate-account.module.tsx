...
export default function ActivateAccount() {
	...
	const [activateAccount, { isLoading, isSuccess, isError }] = useActivateAccountMutation();
	...
	return (
		<div className={styles.container}>
			...
			<p className={styles.container__title}>
				{isSuccess && "Your account has been activated"}
				{isError && "Account already activated"}
			</p>
